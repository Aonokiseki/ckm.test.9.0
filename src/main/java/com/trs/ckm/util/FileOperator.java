...
public final class FileOperator {
	...
	/**
	 * 将二进制数据转换为文件
	 * @param bytes 以二进制方式组成的文件
	 * @param prefix 文件的前缀名
	 * @param suffix 文件的后缀名
	 * @param directory 生成文件的临时目录
	 * @return File 生成的文件的句柄
	 * @throws IOException
	 */
	public static File writeBytesToFile(byte[] bytes, String prefix, String suffix, File directory) throws IOException {
