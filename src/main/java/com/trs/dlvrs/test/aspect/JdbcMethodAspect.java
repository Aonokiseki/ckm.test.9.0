...
public class JdbcMethodAspect {
	...
	static class PointCut{
		final static String ALL = "execution(* org.springframework.jdbc.core.JdbcTemplate.*(..))";
	}
}
